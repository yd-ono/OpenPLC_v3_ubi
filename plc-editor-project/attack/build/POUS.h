...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,EN)
  __DECLARE_VAR(BOOL,ENO)
  __DECLARE_VAR(UINT,INPUT_UINT)
  __DECLARE_VAR(INT,OUTPUT_INT)

  // FB private variables - TEMP, private and located variables
  __DECLARE_VAR(UINT,_TMP_DIV3_OUT)
  __DECLARE_VAR(UINT,_TMP_ABS8_OUT)
  __DECLARE_VAR(INT,_TMP_UINT_TO_INT9_OUT)
...
typedef struct {
  ...
  SCALE_TO_SIGNED SCALE_TO_SIGNED0;
  ...
  SCALE_TO_SIGNED SCALE_TO_SIGNED1;
  SCALE_TO_SIGNED SCALE_TO_SIGNED2;
  SCALE_TO_SIGNED SCALE_TO_SIGNED3;
  SCALE_TO_SIGNED SCALE_TO_SIGNED4;
  SCALE_TO_SIGNED SCALE_TO_SIGNED5;
  SCALE_TO_SIGNED SCALE_TO_SIGNED6;
  SCALE_TO_SIGNED SCALE_TO_SIGNED7;
  SCALE_TO_SIGNED SCALE_TO_SIGNED8;
  SCALE_TO_SIGNED SCALE_TO_SIGNED9;
  PRESSURE_OVERRIDE PRESSURE_OVERRIDE0;
  LEVEL_CONTROL LEVEL_CONTROL0;
  __DECLARE_EXTERNAL(BOOL,RUN_BIT)
  __DECLARE_VAR(BOOL,RUN_BIT0)
  INITIALIZE_SP INITIALIZE_SP0;
  __DECLARE_VAR(UINT,_TMP_ADD87_OUT)
  __DECLARE_VAR(BOOL,_TMP_GE91_OUT)
  __DECLARE_VAR(BOOL,_TMP_MOVE92_ENO)
  __DECLARE_VAR(UINT,_TMP_MOVE92_OUT)
